...
(function () {
    ...
    function ua(k, p, D) {
        ...
        p.getAttribute('state') !== D &&
            ...
            (p.innerHTML =
                "<img style='height:95%; pointer-events: none;' src='" + jb[D].image + "' alt='" + k._cultureInfo[D + 'Text'] + "' />"));
    }
    function Qa() {
    ...
    Na.Chart = (function () {
        ...
        function E(a, d, b, c, e, g, m, l, w, h) {
            ...
            w && 0 < l.thickness
                ...
                : 0 < l.thickness &&
                  (a.moveTo(Math.round((d + c) / 2) - q, b + m.thickness / 2), a.lineTo(Math.round((d + c) / 2) - q, e - m.thickness / 2));
            a.stroke();
            ...
            if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
                for (a = 0; a < this.options.customBreaks.length; a++)
                    this.customBreaks.push(
                        new L(this.chart, 'customBreaks', this.options.customBreaks[a], a, ++this.chart._eventManager.lastObjectId, this)
                    ),
                ...
                if ('normal' === this.plotInfo.axisPlacement || 'xySwapped' === this.plotInfo.axisPlacement) {
                    if (!this.data[d].axisYType || 'primary' === this.data[d].axisYType)
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            ...
                            this.axisY[
                                0 <= this.data[d].axisYIndex && this.data[d].axisYIndex < this.axisY.length ? this.data[d].axisYIndex : 0
                    ...
                    if ('secondary' === this.data[d].axisYType)
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            ...
                            this.axisY2[
                                0 <= this.data[d].axisYIndex && this.data[d].axisYIndex < this.axisY2.length ? this.data[d].axisYIndex : 0
                            ].dataSeries.push(this.data[d]);
                        } else
                            this.axisY2.length ||
                                ('normal' === this.plotInfo.axisPlacement
                    ...
                    if (!this.data[d].axisXType || 'primary' === this.data[d].axisXType)
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            ...
                            this.axisX[
                                0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX.length ? this.data[d].axisXIndex : 0
                            ].dataSeries.push(this.data[d]);
                        } else
                            this.axisX.length ||
                                ('normal' === this.plotInfo.axisPlacement
                    ...
                    if ('secondary' === this.data[d].axisXType)
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            ...
                            this.axisX2[
                                0 <= this.data[d].axisXIndex && this.data[d].axisXIndex < this.axisX2.length ? this.data[d].axisXIndex : 0
                            ].dataSeries.push(this.data[d]);
                        } else
                            this.axisX2.length ||
                                ('normal' === this.plotInfo.axisPlacement
                                    ...
                                    : 'xySwapped' === this.plotInfo.axisPlacement &&
                                      this._axes.push((this.axisX2[0] = new z(this, 'axisX2', this.options.axisX2, 0, 'axisX', 'right')))),
        ...
        p.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (
                    var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, e, g = !1, m = [], l = [], w = Infinity, h = -Infinity, s = 0;
                            ...
                            if (!(4 > k.dataPoints.length))
                                for (w = 0; w < k.dataPoints.length; w++)
                                    if (
                                        (c &&
                                            ((q =
                                                ((l + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) /
                                                100),
        ...
        p.prototype.validateRegion = function (a, d, b, c, e) {
            e = e || !1;
            for (
                var g = 0 <= this.zoomType.indexOf('x'), m = 0 <= this.zoomType.indexOf('y'), l = !1, w = [], h = [], s = [], q = 0;
                q < this._axes.length;
                q++
            )
        ...
        p.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                var m = na('indexLabelFontWeight', h.dataPoint, h.dataSeries),
                    ...
                    c =
                        0 < p
                            ? Math.min(10, ('normal' === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0)
                            : 0,
                        ...
                        0 <= s.indexOf('line') || 0 <= s.indexOf('area') || 0 <= s.indexOf('scatter')
                            ...
                            'inside' !== t
                                ? ((m = b.x1),
                                  ...
                                  0 > ma
                                      ? ((q = h.point.x - l - e - c),
                                        q < m && ((q = 'auto' === t ? Math.max(h.point.x, m) + e + c : m + e + c), (v = q + l > h.point.x)))
                                      : ((q = h.point.x + e + c),
                                        q > g - l - e - c &&
        ...
        p.prototype.renderPie = function (a) {
            ...
            function b(a) {
                ...
                for (b = 0; b < s.length; b++) {
                    ...
                    if (e > c) {
                        ...
                        m &&
                            ((d = {}), (d.dataSeries = h), (d.dataPoint = h.dataPoints[b]), (d.index = b), k.toolTip.highlightObjects([d]));
                        ja(
                            k.plotArea.ctx,
                            f[b].center,
                            f[b].radius,
            ...
            function l() {
                ...
                k.title &&
                    (k.title.dockInsidePlotArea || ('center' === k.title.horizontalAlign && 'center' === k.title.verticalAlign)) &&
                    k.title.render();
                if (k.subtitles)
                ...
                k.legend &&
                    (k.legend.dockInsidePlotArea || ('center' === k.legend.horizontalAlign && 'center' === k.legend.verticalAlign)) &&
        ...
        p.prototype.renderFunnel = function (a) {
            ...
            function c() {
                if (t && C) {
                    for (
                        var a, b, c, e, d, g, l, h, m, n, k, q, s, w, p = [], B = [], x = { percent: null, total: null }, v = null, y = 0;
                        y < C.length;
                        y++
                    )
                        (w = P[y]),
            ...
            function v(a) {
                ...
                a.roundRect || Ea(a);
                z.title &&
                    (z.title.dockInsidePlotArea || ('center' === z.title.horizontalAlign && 'center' === z.title.verticalAlign)) &&
                ...
                z.legend &&
                    (z.legend.dockInsidePlotArea || ('center' === z.legend.horizontalAlign && 'center' === z.legend.verticalAlign)) &&
        ...
        z.prototype.createLabels = function () {
            ...
            if ('bottom' === this._position || 'top' === this._position)
                ...
                (l =
                    ...
                    this.chart.panEnabled ||
                        (g =
                            'undefined' === typeof this.options.labelMaxWidth ? (0.3 * this.chart.width) >> 0 : this.options.labelMaxWidth),
                    (m =
                        'undefined' === typeof this.options.labelWrap || this.labelWrap
                        ...
                        for (b = 0; b < this._labels.length; b++)
                            (a = this._labels[b].textBlock),
                                (a.maxWidth = this.labelMaxWidth =
                                    u(this.options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth),
                                (a.fontSize = this.labelFontSize =
                                    u(this.options.labelFontSize) ? this.sessionVariables.labelFontSize : this.options.labelFontSize),
                                (a.angle = this.labelAngle =
                                    u(this.options.labelAngle) ? this.sessionVariables.labelAngle : this.labelAngle),
                                (a.wrap = this.labelWrap =
                                    u(this.options.labelWrap) ? this.sessionVariables.labelWrap : this.options.labelWrap),
                                (a.maxHeight = this.sessionVariables.labelMaxHeight),
                                a.measureText();
                else if ('left' === this._position || 'right' === this._position)
                    if (
            ...
            for (b = 0; b < this.stripLines.length; b++) {
                ...
                a = new ka(this.ctx, {
                    ...
                    horizontalAlign: 'left',
                    fontSize:
                        'outside' === g.labelPlacement ? (g.options.labelFontSize ? g.labelFontSize : this.labelFontSize) : g.labelFontSize,
                    fontFamily:
                    ...
                    fontStyle:
                        'outside' === g.labelPlacement ? (g.options.labelFontStyle ? g.labelFontStyle : this.fontWeight) : g.labelFontStyle,
                    textBaseline: 'middle'
                });
        ...
        z.prototype.createMask = function () {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                r
                    ? ((this.maskCanvas = ta(this.chart.width, this.chart.height)), (this.maskCtx = this.maskCanvas.getContext('2d')))
        ...
        z.prototype.calculateLogarithmicAxisParameters = function () {
            ...
            'axisX' === this.type
                ? ((c = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin),
                  ...
                  1 === e / c &&
                      ((m = Math.pow(this.logarithmBase, 'undefined' === typeof this.options.interval ? 0.4 : this.options.interval)),
                      (e *= m),
                      (c /= m)),
                  (g =
                      Infinity !== this.dataInfo.minDiff
        ...
        X.prototype.render = function () {
            ...
            var a = this.parent.getPixelCoordinatesOnAxis(this.value),
                d = Math.abs(
                    'pixel' === this._thicknessType ? this.thickness : this.parent.conversionParameters.pixelPerUnit * this.thickness
                );
            if (0 < d) {
                        ...
                        0 === l &&
                            ...
                            (this.chart.axisX && 0 < this.chart.axisX.length
                                ...
                                : this.chart.axisX2 &&
                                  ...
                                  (h += 'undefined' !== typeof this.chart.axisX2[0].labels[c.x] ? this.chart.axisX2[0].labels[c.x] : '{x}'),
                            (h += '</br>'),
